...
pull-request lane (`REQ-032`) drives the official `gh` client with an approver
named on the command and cannot merge. The certificate a signed distribution
needs is `REQ-036`'s external gate.
