# EP-001 - Desktop foundation

**Requirements:** REQ-039,REQ-040,REQ-041,REQ-053

**Purpose:** Tauri shell, Rust workspace, React shell, SQLite bootstrap, configuration.
...
**Required proof:** unit foundation, desktop launch, migration smoke. Evidence is stored under `.agent/evidence/EP-001/` with hashes and command exit codes.
