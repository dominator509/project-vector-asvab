# EP-007 - Testing and hardening

**Requirements:** REQ-050,REQ-051,REQ-052,REQ-055,REQ-056

**Purpose:** full test families, mutation, fuzz/property, performance and recovery harness.
...
**Required proof:** registered accounting, zero required skips, clean-room and chaos evidence. Evidence is stored under `.agent/evidence/EP-007/` with hashes and command exit codes.
