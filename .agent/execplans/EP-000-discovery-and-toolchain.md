...
**Requirements:** REQ-037,REQ-038,REQ-058

**Purpose:** repository skeleton, toolchain pins, license inventory, capability probes.
...
**Required proof:** PREFLIGHT, clean tool versions, generated-pack validation. Evidence is stored under `.agent/evidence/EP-000/` with hashes and command exit codes.
