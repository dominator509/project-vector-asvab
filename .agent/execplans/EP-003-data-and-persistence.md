...
**Purpose:** SQLite repositories, migrations, evidence vault, signed packs, backup/restore.
...
**Required proof:** restart persistence, migration, corruption, rollback, concurrent access. Evidence is stored under `.agent/evidence/EP-003/` with hashes and command exit codes.
