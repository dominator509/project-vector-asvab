...
**Objective:** Restore backup, recover interrupted exam, verify crash signatures/redaction, reconcile incomplete async work, and validate diagnostic sufficiency.
